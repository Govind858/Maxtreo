...
const OrderList = () => {
  ...
  const updateOrderStatus = async (status) => {
    try {
      ...
      await updateStatus(selectedOrder.id, status.toUpperCase());
  ...
  return (
    ...
    <div className="flex flex-col min-h-screen" style={{ marginTop: "60px" }}>
      <div className="flex-1 bg-white rounded-lg shadow-lg p-6" style={{width:"90%", margin:"auto"}}>
        {error && (
          <div
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-gray-600">User ID: {selectedOrder.user}</p>
              </div>
