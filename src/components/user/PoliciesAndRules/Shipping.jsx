    ...
    <>
      ...
      <div className="flex flex-col p-4 lg:p-6 gap-6 max-w-6xl mx-auto bg-white pt-24 pb-12" style={{ fontFamily: "'Rajdhani', sans-serif" }}>
        <div className="text-center mb-8">
          <h1 className="text-3xl lg:text-4xl font-bold text-blue-600 mb-4 tracking-tight">
            Shipping Policy
          </h1>
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 border-2 border-blue-500 shadow-lg hover:shadow-xl transition-shadow" style={{ borderRadius: '0' }}>
            <div className="flex items-start mb-4">
              <div className="bg-blue-500 p-3 mr-4 flex-shrink-0" style={{ borderRadius: '0' }}>
            ...
            <p className="text-base text-gray-800 leading-relaxed pl-10">
          ...
          <div className="bg-white p-6 border-2 border-green-500 shadow-lg hover:shadow-xl transition-shadow" style={{ borderRadius: '0' }}>
            <div className="flex items-start mb-4">
              <div className="bg-green-500 p-3 mr-4 flex-shrink-0" style={{ borderRadius: '0' }}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="bg-white p-6 border-2 border-yellow-500 shadow-lg hover:shadow-xl transition-shadow" style={{ borderRadius: '0' }}>
            <div className="flex items-start mb-4">
              <div className="bg-yellow-500 p-3 mr-4 flex-shrink-0" style={{ borderRadius: '0' }}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-base text-gray-800 leading-relaxed pl-10">
              <strong className="text-gray-800">Metro Cities:</strong> 3-5 business days after dispatch
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10">
              <strong className="text-gray-800">Tier-2 Cities:</strong> 5-7 business days after dispatch
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10">
              <strong className="text-gray-800">Tier-3 Cities & Remote Areas:</strong> 7-10 business days after dispatch
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10">
          ...
          <div className="bg-white p-6 border-2 border-red-500 shadow-lg hover:shadow-xl transition-shadow" style={{ borderRadius: '0' }}>
            <div className="flex items-start mb-4">
              <div className="bg-red-500 p-3 mr-4 flex-shrink-0" style={{ borderRadius: '0' }}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-base text-gray-800 leading-relaxed pl-10">
              <strong className="text-gray-800">Standard Shipping:</strong> ₹150-500 (varies by location and product weight)
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10">
              <strong className="text-gray-800">Express Shipping:</strong> ₹300-800 (metro cities only)
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10">
              <strong className="text-gray-800">Heavy Items (PCs/Workstations):</strong> ₹500-1,200 based on destination
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10">
              <strong className="text-gray-800">Free Shipping:</strong> Available on orders above ₹50,000 or during promotional campaigns.
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10">
          ...
          <div className="bg-white p-6 border-2 border-yellow-500 shadow-lg hover:shadow-xl transition-shadow" style={{ borderRadius: '0' }}>
            ...
            <p className="text-base text-gray-800 leading-relaxed pl-10">
              <strong className="text-gray-800">Reporting Process:</strong>
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10">
          ...
          <div className="bg-white p-6 border-2 border-blue-500 shadow-lg hover:shadow-xl transition-shadow" style={{ borderRadius: '0' }}>
            ...
            <p className="text-base text-gray-800 leading-relaxed pl-10">
              <strong className="text-gray-800">Fragile Electronics:</strong> Graphics cards, motherboards, and sensitive components receive extra protective packaging.
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10">
              <strong className="text-gray-800">Large Items:</strong> Complete PC systems and workstations are shipped via specialized logistics partners with white-glove delivery service.
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10">
              <strong className="text-gray-800">Installation Support:</strong> Optional on-site setup assistance available for complete systems in select cities.
            </p>
          </div>
          ...
          <div className="bg-white p-6 border-2 border-green-500 shadow-lg hover:shadow-xl transition-shadow" style={{ borderRadius: '0' }}>
            ...
            <p className="text-base text-gray-800 leading-relaxed pl-10 flex items-center">
              ...
              <strong className="text-gray-800">Email:</strong> maxtreo99@gmail.com
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-green-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <strong className="text-gray-800">Phone:</strong> +91 94955 26026
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 text-green-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
              </svg>
              <strong className="text-gray-800">WhatsApp:</strong> +91 94955 26026
            </p>
            <p className="text-base text-gray-800 leading-relaxed pl-10">
