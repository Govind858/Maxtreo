      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center md:text-left">
                ...
                <ul className="space-y-2 inline-block md:inline-block">
                  ...
                  <li><a href="/products" className="text-sm text-gray-300 hover:text-white transition-colors block md:inline-block">Products</a></li>
                  <li><a href="/support" className="text-sm text-gray-300 hover:text-white transition-colors block md:inline-block">Support</a></li>
                  <li><a href="/contact" className="text-sm text-gray-300 hover:text-white transition-colors block md:inline-block">Contact</a></li>
                </ul>
              </div>
              ...
              <div className="text-center md:text-left">
                ...
                <ul className="space-y-2 inline-block md:inline-block">
                  <li><a href="/gaming-pcs" className="text-sm text-gray-300 hover:text-white transition-colors block md:inline-block">Gaming PCs</a></li>
                  <li><a href="/peripherals" className="text-sm text-gray-300 hover:text-white transition-colors block md:inline-block">Peripherals</a></li>
                  <li><a href="/accessories" className="text-sm text-gray-300 hover:text-white transition-colors block md:inline-block">Accessories</a></li>
                  <li><a href="/workstations" className="text-sm text-gray-300 hover:text-white transition-colors block md:inline-block">Workstations</a></li>
                </ul>
              </div> */}
        ...
        <div className="border-t border-gray-800 pt-6 mt-8">
          <div className="flex flex-col md:flex-row justify-center md:justify-between items-center">
            <p className="text-sm text-gray-300 mb-4 md:mb-0 text-center">&copy; 2025 maxtreo. All rights reserved.</p>
