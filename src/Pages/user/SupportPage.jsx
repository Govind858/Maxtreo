...
const HeaderCard = () => (
  ...
  >
    ...
    <div className="h-1 bg-black w-full mt-2" style={{height:"10px",marginTop:"6px"}}></div>
  </motion.div>
);
        ...
        <div className="flex flex-col md:flex-row " style={{gap:"30px"}}>
          ...
          <div className="w-full md:w-7/12 p-8 bg-white" style={{border:"1.5px solid black",borderRadius:"20px",padding:"30px"}}>
            ...
            <div className="border-b border-gray-300 pb-6 mb-6">
              ...
              <p className="text-sm">For Queries contact us at <a href="mailto:maxtreo99@gmail.com@gmail.com" className="text-blue-600">maxtreo99@gmail.com</a></p>
            </div>
...
function SupportPage() {
  ...
  return (
    <div 
      ref={containerRef} 
      className="min-h-screen bg-gradient-to-r from-white to-blue-300"
